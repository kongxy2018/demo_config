...
//        PublicKey publicKey = geneneratePublicKey(public_key);
//
...
//     * @throws Exception
//     */
//    public static PublicKey geneneratePublicKey(String key) throws InvalidKeySpecException, NoSuchAlgorithmException, IOException {
//        byte[] decodeKeyinfo = (new BASE64Decoder()).decodeBuffer(key);
